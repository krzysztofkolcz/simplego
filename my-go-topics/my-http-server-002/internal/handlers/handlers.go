...
import (
	...
	"github.com/krzysztofkolcz/my-http-server-002/internal/apierrors"
	"github.com/krzysztofkolcz/my-http-server-002/internal/log"
...
func ParamsErrorHandler() func(w http.ResponseWriter, r *http.Request, err error) {
	return func(w http.ResponseWriter, r *http.Request, err error) {
		...
		var errorResponse myhttpserver2.ErrorMessage

		var (
			invalidFormatErr     *myhttpserver2.InvalidParamFormatError
			requiredHeaderErr    *myhttpserver2.RequiredHeaderError
			tooManyParametersErr *myhttpserver2.TooManyValuesForParamError
			requiredParamErr     *myhttpserver2.RequiredParamError
		)
